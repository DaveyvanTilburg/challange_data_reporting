...
{
    //Todo, unfinished because I realized I should first make an MVP
    public class GroupPerMonth<T> : IPointGrouping<T> where T : class, IDateGroupable, ITypeGroupable
    {
        private readonly ILineGrouping<T> _lineGrouping;

        public GroupPerMonth(ILineGrouping<T> lineGrouping)
        {
